...
public class Option5Activity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        findViewById(R.id.back_btn_5).setOnClickListener(new InnerOnClickListener());
        findViewById(R.id.next_btn_5).setOnClickListener(new InnerOnClickListener());
    }
