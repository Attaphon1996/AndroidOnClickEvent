...
public class Option4Activity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        findViewById(R.id.back_btn_4).setOnClickListener(onClickListener);
        findViewById(R.id.next_btn_4).setOnClickListener(onClickListener);
    }
